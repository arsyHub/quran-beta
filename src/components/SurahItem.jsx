...
export default function SurahItem({ surahNumber }) {
  ...
  return (
    <div>
      ...
      <div className=" px-5">
        <div className="bg-gradient-to-r from-green-400  to-[#00957D] rounded-xl p-5">
          ...
          <p className="text-[#f2f4f6] text-xs sm:text-sm">
            {dataSurahItem.data.arti} - {dataSurahItem.data.jumlahAyat} Ayat -{" "}
            {dataSurahItem.data.tempatTurun}
          </p>
        </div>
      </div>
      ...
      <div className="overflow-y-scroll h-[77vh] pb-16">
        {dataSurahItem?.data?.ayat?.map((ayat) => (
          <div
            key={ayat.nomorAyat}
            className="mt-5  mx-5 bg-white p-5 rounded-md"
          >
            ...
            <p className="text-[#00957D] text-2xl sm:text-3xl text-right">
              {ayat.teksArab}
            </p>

            <div className="mt-10">
              <p className="text-[#00957D] font-bold text-sm">
                {ayat.teksLatin}
              </p>
              <p className="text-[#000000] mt-1 text-sm">
                {ayat.teksIndonesia}
              </p>
            </div>
